    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Form Tambah Data Peminjaman Buku</h4>
                        <?php
                        ...
                        ?>
                        <form class="forms-sample" action="module/peminjaman/aksi_tambah_data_buku_peminjaman.php" method="post" id="">
