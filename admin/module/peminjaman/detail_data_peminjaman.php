...
include "/xampp/htdocs/perpus/admin/config/koneksi.php";
        ...
        $i = 1;
        $sql =
            "SELECT id_peminjaman, nama_anggota, nama_staff, tanggal, waktu, anggota.id_anggota FROM peminjaman
        ...
        if ($ress) {
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="m-0">Detail Peminjaman Buku</h5>
            </div>
...
<div class="card-body">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        onclick="location.href='index.php?module=tambah_data_buku_peminjaman&id_peminjaman=<?php echo $data['id_peminjaman']?>';">Tambah Peminjaman Buku</button>
      </div>
