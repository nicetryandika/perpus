        ...
        <ul class="nav">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
             ...
             <?php
                    if (isset($_SESSION['anggota_username'], $_SESSION['auth_level'])) {
                      echo '<a class="dropdown-item" href="">' . $_SESSION['anggota_username'] . ' (' . $_SESSION['auth_level'] . ')</a>';
                  }
              ...
              ?>
              <a class="dropdown-item" href="?module=profile">Profile</a>
      ...
      <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar navbar-light">
            ...
            <div class="w-100 mb-4 d-flex">
                <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="dashboard_anggota.php?module=">
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                <li class="nav-item w-100">
                    <a class="nav-link" href="dashboard_anggota.php?module=">
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="laporan">
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="?module=laporan_peminjaman">
                              <span class="ml-1 item-text">Profile Anggota</span>
                            </a>
                        </li>
                    </ul> -->
        </nav>
