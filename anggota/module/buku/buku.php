...
<div class="card-body">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        onclick="location.href='dashboard_anggota?module=tambah_data_buku';">Tambah Buku</button>
      </div>
                ...
                while ($data = mysqli_fetch_array($ress)) {
                    ...
                    '<tr>
                        ...
                        <td class="text-center">
                            <a href="dashboard_anggota?module=edit_data_buku&kd_buku='.$data['kd_buku'].'" class="btn btn-primary btn btn-sm">Edit</a>
